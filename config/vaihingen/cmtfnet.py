...
weights_name = "cmtfnet-r50-1024-crop-ms-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "cmtfnet-r50-1024-crop-ms-e100"
...
# define the loss
loss = SoftCrossEntropyLoss(smooth_factor=0.06, ignore_index=ignore_index)
use_aux_loss = False
